...
public sealed class TheCure : Standx
{
    ...
    public override void Back_Atk() => Hit.Atk(atk); // HEAL

    public override void Neutral_SpAtk() => Hit.Atk(wind_box,
    ...
    public override void Back_SpAtk() => Hit.Atk(wind_box); //HEAL
	...
	public override void Aerial_Side_SpAtk() => Hit.Atk(wind_box, (Collider hit) =>
        {
	...
	public override void Aerial_Back_SpAtk() => Hit.Atk(wind_box);
